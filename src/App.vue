              ...
              <ul class="nk-contacts-icons">
                ...
                <li>
                  <span class="nk-cart-toggle"
                    ><span class="nk-badge">1</span><span class="fa fa-users"></span
                  ></span>
                  <div class="nk-cart-dropdown">
                    <div class="text-center">
                      <a class="nk-cart-remove-item" href="javascript:void(0)"
                        ><span class="fas fa-times"></span></a
                      ><a href="javascript:void(0)">No tienes Solicitudes de Amistad</a>
                    </div>
          ...
          <div class="container-fluid">
            <div class="nk-nav-table">
              ...
              >
                ...
                <li><router-link to="/servidores">Servidores</router-link></li>
                <li><router-link to="/noticias">Noticias</router-link></li>
                <li><router-link to="/top">Top Global</router-link></li>
                <li><router-link to="/chat">Chat Global</router-link></li>
                <li><router-link to="/tienda">tienda</router-link></li>
              </ul>
              <ul class="nk-nav nk-nav-right nk-nav-icons">
                <li class="single-icon d-lg-none">
                  <a class="no-link-effect" href="#" data-nav-toggle="#nk-nav-mobile"
